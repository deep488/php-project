...
if(isset($_POST['submit']))
	{
		...
		$inssql="INSERT INTO polity(question_number,question_text)VALUES('$question_number','$question_text')";
		...
		$insrtsql="INSERT INTO po_options(question_number,is_correct,poption)VALUES('$question_number','$is_correct','$value')";	
...
<html>
	<head>
		<title> Make Polity Questions </title>
		<link rel="stylesheet"  type="text/css" href="css/style.css">
	</head>
	<body>
		<div>
			<h1 style="color:purple;"> Now you can make polity questions !!!</h1>
			<div class="container">
			...
			<form method="POST" action="polityadminpage.php">
				<div class="outbx">
				<div class="input-bx">

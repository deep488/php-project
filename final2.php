...
$count=mysqli_num_rows(mysqli_query($db_handle,$sql));
session_start();
...
<body>
	...
	<h2 style="color:green;font-size:24px;font-weight:400;"> Congratulation You Have Successfully Completed Your GEOGRAPHY Test </h2>

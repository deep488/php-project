...
<?php 
session_start(); 
$_SESSION['$sc']=$selected_choice;
//$_SESSION['$correct_choice'];
	...
	if(!isset($_SESSION['score'])){
 	...
 	if($_POST){
		...
		//Determine the correct choice for current question
	 	$query = "SELECT * FROM ge_options WHERE question_number = $number AND is_correct = 1";
 	 ...
 	 {
 	 	header('location:getgeographyqus.php?n='.$next);
 	 }
